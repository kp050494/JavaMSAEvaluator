...
/**
 * JUnit 5 TestWatcher that emits machine-parseable markers to stdout for each
 * test outcome. The backend's Judge0Service parses these lines out of the
 * captured Maven build log.
 *
 * Marker format (one per test):
